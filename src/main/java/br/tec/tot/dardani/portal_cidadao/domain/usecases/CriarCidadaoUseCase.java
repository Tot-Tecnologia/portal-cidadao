...
import br.tec.tot.dardani.portal_cidadao.infrastructure.data.persistence.mappers.CidadaoMapper;
...
public class CriarCidadaoUseCase {
    ...
    public CidadaoCriadoResponse executar(CidadaoRequest request) {

        var usuarioEncontrado = usuarioRepository.buscarUsuario(request.email(), request.cpfCnpj());
        ...
        firebaseRepository.criarUsuario(request, cidadaoCriado.getId());
