...
import br.tec.tot.dardani.portal_cidadao.domain.usecases.AdicionarDocumentosUseCase;
import br.tec.tot.dardani.portal_cidadao.domain.usecases.AdicionarGuiasUseCase;
import br.tec.tot.dardani.portal_cidadao.domain.usecases.BuscarProtocoloUseCase;
import br.tec.tot.dardani.portal_cidadao.domain.usecases.BuscarProtocolosUseCase;
import br.tec.tot.dardani.portal_cidadao.domain.usecases.CriarProtocoloUseCase;
...
public class ProtocoloController {
    ...
    public ResponseEntity<ProtocoloCriadoResponse> criarProtocolo(
            @Valid @ModelAttribute ProtocoloRequest request) {
